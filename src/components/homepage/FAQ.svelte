<div class="bg-black px-8 pb-12 sm:pt-8 sm:pb-20">
...
<style>
  .question { @apply font-body text-white text-xl sm:text-2xl mt-6 sm:mt-10; }
  .answer { @apply font-body text-gray-200 text-base sm:text-xl mt-2; }
</style>